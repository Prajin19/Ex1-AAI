...
nx.draw_networkx(n, with_labels=True, labels=d, pos=pos, **options)
...
```
## Output:
<img width="892" height="592" alt="image" src="https://github.com/user-attachments/assets/d6a080bf-5701-48c9-91b1-0ec9df10a5fe" />

<img width="1240" height="141" alt="image" src="https://github.com/user-attachments/assets/f5e3243e-4b5b-4dcc-bff6-c61e870ad717" />
